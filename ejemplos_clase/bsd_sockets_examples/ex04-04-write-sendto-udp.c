/* Envio de datos sobre UDP usando connect y write */
#include <stdio.h>
#include <sys/types.h>
...
int main(int argc, char *argv[])
{
  ...
  /* Podemos usar sendto si especificamos la misma address*/
  sendto(s,"aca uso sendto despues de connect",33, 0 , servinfo->ai_addr, servinfo->ai_addrlen);
  sleep(10);
  close(s);
}
